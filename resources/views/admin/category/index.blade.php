                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary destroy-cat" data-bs-toggle="modal" data-bs-target="#exampleModal" data-link="{{route('categories.destroy',$category->id)}}">Delete
                                    </td>
                                </tr>
                               @endforeach
                            </tbody>
